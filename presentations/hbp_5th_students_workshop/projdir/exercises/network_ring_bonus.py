...
# (10) Set up the hardware context, MPI object
comm = TODO
print(comm)
...
ncells = TODO # How will you process the results and verify?
...
for gid in range(ncells):
    #Handle the fact that samples() only knows about local handles, it will return an empty list for remote handles.
