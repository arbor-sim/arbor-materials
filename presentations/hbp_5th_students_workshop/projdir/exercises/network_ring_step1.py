...
def make_cable_cell(gid):
    ...
    b1 = tree.append(b0, arbor.mpoint(50, 0, 0, 2), arbor.mpoint(50, 50, 0, 0.5), tag=3)
    # Constant radius of 1 μm over the length of the dendrite.
    b2 = tree.append(b0, arbor.mpoint(50, 0, 0, 1), arbor.mpoint(50, -50, 0, 1), tag=3)

    # Associate labels to tags
    labels = arbor.label_dict()
    labels['soma'] = '(tag 1)'
    labels['sandras_dendrite'] = '(tag 3)'
    ...
    decor.paint('"soma"','hh')
    # decor.paint('(tag 1)','hh')

    decor.paint('"sandras_dendrite"','pas')
