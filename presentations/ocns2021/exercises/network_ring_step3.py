...
# https://docs.arbor-sim.org/en/latest/python/hardware.html
# https://docs.arbor-sim.org/en/latest/python/domdec.html
# https://docs.arbor-sim.org/en/latest/python/simulation.html
context = TODO
decomp = TODO
sim = TODO
