Arbor Developer Meeting 2022 11 24
==================================
...
Presence: BH, NA, TH, AK, Sebastian Schmitt, Lennart Landsmeer, Max Engelen, Amo(Ali Hosseini),
...
* Features: 
    * Mechanism ABI [#1376](https://github.com/arbor-sim/arbor/issues/1376);
        * [ME] Can the mach abi build script also take in C++ (non nmodl)?
        * TODO [ME]: Please open an issue
        * TODO [AK/BH]: Put this on top of backlog
...
* Incomplete features: 
    * Python performance profiler [#1685](https://github.com/arbor-sim/arbor/issues/1685) missing [#1691](arbor-sim/arbor#1691)
    * S-expression representation of CV-policies [#1334](https://github.com/arbor-sim/arbor/issues/1334), [PR#1511]( https://github.com/arbor-sim/arbor/pull/1511) missing [#1765](https://github.com/arbor-sim/arbor/issues/1765)
        * driven by arbor-gui (formally to be released in v0.6); able to export to ACC format
...
| []() |  |  |  |  |
| [1403](https://github.com/arbor-sim/arbor/issues/1403) | Python installation through CMake improvements | in progress | v0.6?--> close; linked to [PR1413](https://github.com/arbor-sim/arbor/pull/1413)? [BH] add comment to use `pip install` (core issue with cmake install is lib directory); [SS] use spack; | [LL] will create issue for not installing arbor build cataloges with pip --> v0.6 |
...
| [1621](https://github.com/arbor-sim/arbor/issues/1621) | [NML2] Extend NeuroML Coverage | in progress | [LL+TH] contact TH for detailed discussion | v0.6 |
| [1480](https://github.com/arbor-sim/arbor/issues/1480)| Add epoch end time to spike callbacks | in progress | need more robust solution, discuss prio with [in-situ pipeline project](https://devhub.vr.rwth-aachen.de/VR-Group/in-situ-pipeline), TH will contact Wouter Kljin | v0.7 |
| []() |  |  |  |  |
...
| [1437](https://github.com/arbor-sim/arbor/issues/1437) | Onboarding new developers: A guided tour of Arbor | next release | [BH] Move checklist from PR to issue (and update), request review max, lennart for review of PR when marked ready | Merge [PR1639](https://github.com/arbor-sim/arbor/pull/1639) in v0.6 |
| [1263](https://github.com/arbor-sim/arbor/issues/1263)| Probes for LIF cells | next release | ArborIO (for ME, and Elias), v0.7? -->ArborIO is using Mech ABI instead; NA keeps it in backlog for arbor feature. Partially related [1605 - BYO cell group](https://github.com/arbor-sim/arbor/issues/1605) (no high prio for ArborIO, but would make arbor more attractable for users) | v0.7 | 
| [1232](https://github.com/arbor-sim/arbor/issues/1232) | Streaming recording of sampled data and spikes | next release | (high) prio tbd with [in-situ pipeline project](https://devhub.vr.rwth-aachen.de/VR-Group/in-situ-pipeline) (v0.6/0.7)? --> TH please discuss with Wouter Klijn as well| v0.7 |
| [1604](https://github.com/arbor-sim/arbor/issues/1604) | Convert tutorials to Jupyter Notebooks | next release |  [BH] planned a PR; [LL] IO cells will be on Jupyter notebooks | v0.7 |
| [1369](https://github.com/arbor-sim/arbor/issues/1369) | Documentation: tutorial structure, howtos | next release | ongoing work; [BH] planned a PR | v0.7 |
| []() |  |  |  |  |
| [1764](https://github.com/arbor-sim/arbor/issues/1764) | Arbor-compatible NMODL representation of AMPA, NMDA, and GABA synapses | backlog | SY's [notes](https://demo.hedgedoc.org/HNQ4vBLlRDWWbC29BgYGMQ); feedback needed from ArborIO --> NA will contact Stefano; Robin asked for it | no version (yet) |
| [1655](https://github.com/arbor-sim/arbor/issues/1655) | Stochastic differential equations in mechanisms | backlog| ArborIO & FIPPA; to be implemented by Fabian Bösch (working parttime); teams use patch with mech abi; ME can share CPU+GPU code (https://github.com/max9901/arbor/tree/master+EMC-Catalogue/mechanisms/EMC/EMC_Mechs); NA: random123 will be a module; ME will open an issue for random123 errors with CUDA | v0.7 |
...
| [1650](https://github.com/arbor-sim/arbor/issues/1650) |Inhomogeneous parameters | backlog | FIPPA; proposal for implementation sketched by SY; big feature; v0.6/v0.7/>? | v0.8 |
| [1343](https://github.com/arbor-sim/arbor/issues/1343) | Voltage clamps | backlog | FIPPA; v0.7 (suggested by Sebastian Schmitt); no specific prio; Espen Hagen might need this for LFPy(kit) | top of backlog, w/o tag |
| [1709](https://github.com/arbor-sim/arbor/issues/1709) | Receive spikes on electrical gap junctions | backlog | ArborIO; more info needed to review feasibility: LL refers to paper in issue; NA keep synapse and GJ mechs and combine with fake ion; LL no high prio; NA+LL meet for details on paper in Dec2021 | top of backlog, w/o tag|
| []() |  |  |  |  |
...
* Mech ABI for other cells? Bring your own Cell group?
    ...
    * no high prio for ArborIO, but makes arbor more attractable for users
...
| [1022](https://github.com/arbor-sim/arbor/issues/1022) | C++17 migration | next release | quality, verify with BC before closing (only few minor issues open) | v0.7 |
| []() |  |  |  |  |
| [1765](https://github.com/arbor-sim/arbor/issues/1765) | Allow s-expr cv-policies using the python interface | backlog | v0.6; not assigned; remove from next release? yes | backlog |
| [1221](https://github.com/arbor-sim/arbor/issues/1221) | Library-provided parameterized cell recipe | backlog | v0.7?; feature; not assigned; remove from next release? yes; TH using Learning-2-Learn | v0.7 |
